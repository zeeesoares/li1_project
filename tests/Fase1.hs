...
testesT2_terrenos = TestLabel "#proximosTerrenosValidos" $ test
  [ "Mapa 01" ~: True ~=? checkAll [isRio, isEstrada, isRelva] (proximosTerrenosValidos 1 mapa01)
  , "Mapa 02" ~: True ~=? checkAll [ isEstrada, isRio] (proximosTerrenosValidos 2 mapa02)
  , "Mapa 03" ~: True ~=? checkAll [isRio, isEstrada, isRelva] (proximosTerrenosValidos 1 mapa03)
  , "Mapa 04" ~: True ~=? checkAll [isEstrada, isRio] (proximosTerrenosValidos 1 mapa04)
  , "Mapa 05" ~: True ~=? checkAll [isEstrada, isRelva] (proximosTerrenosValidos 1 mapa05)
  ]
